...
export default function Pricing() {
    ...
    const products = (products, infos, name, desc, price, href) => (
        <div className="mx-auto sm:max-w-2xl rounded-md ring-1 ring-gray-200 mt-10 lg:mx-0 lg:flex lg:max-w-none dark:ring-gray-900 dark:bg-gray-950">
            ...
            <div className="p-8 sm:p-10 lg:flex-auto">
                ...
                <p className="mt-6 text-base leading-7 text-gray-600 dark:text-gray-300">{desc}</p>
                <div className="mt-4 flex items-center gap-x-4">
                    <h4 className="flex-none text-sm font-semibold leading-6 text-blue-black">Está incluso</h4>
                    <div className="h-px flex-auto bg-gray-100 dark:bg-gray-700"></div>
                </div>
                <ul role="list" className="mt-8 grid grid-cols-1 gap-4 text-sm leading-6 text-gray-600 sm:grid-cols-2 sm:gap-6 dark:text-gray-300">
            ...
            <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                <div className="h-full rounded-md bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16 dark:bg-gray-900">
                    <div className="mx-auto max-w-sm px-4 md:px-8 md:max-w-xs">
                        <p className="text-base font-semibold text-gray-600 dark:text-gray-300">Por apenas</p>
                        <p className="mt-6 flex items-baseline justify-center gap-x-2">
                            <span className="text-5xl font-bold tracking-tight text-gray-900 dark:text-gray-100">{price}</span>
                            <span className="text-sm font-semibold leading-6 tracking-wide text-gray-600 dark:text-gray-300">/mes</span>
                        </p>
                        <Link to={href}>
                            <button className="mt-10 block w-full rounded-md bg-blue px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:blue-black">Assinar</button>
                        </Link>

                        <p className="mt-6 text-xs leading-5 text-gray-600 dark:text-gray-300">Na renovação serão entregue novas contas das plataformas.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    return (
        <div className="bg-white py-10 sm:py-10 dark:bg-black">
                ...
                <div className="w-auto mx-auto block items-center xl:flex justify-center">
                    <div className="w-full flex items-center justify-center sm:mb-10">
                        <div className="text-center max-w-2x1 p-8">
                            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-white">Streaming preço justo</h2>
                            <p className="mt-6 text-lg leading-7 text-gray-600 dark:text-gray-300">Bem-vindo à Razucco, loja de contas de streaming compartilhadas! Nós oferecemos acesso a uma ampla variedade de plataformas de streaming de vídeo por uma fração do preço de uma conta individual.</p>
                        </div>
                    </div>

                    <div className="w-full flex items-center justify-center">
                        <img src={window.matchMedia('(prefers-color-scheme: dark)').matches === true ? "./imgs/discountb.png" : "./imgs/discount.png"} className="h-96 object-cover object-center rounded-none lg:rounded-l-md ml-18 mr-18" alt="" />
                    </div>
                </div>
